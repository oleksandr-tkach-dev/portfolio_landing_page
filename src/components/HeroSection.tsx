    ...
    return (
        ...
        >
            ...
            <div className="relative z-10 max-w-7xl mx-auto w-full section-padding pt-32">
                ...
                >
                    Mobile engineer with <strong className="text-foreground font-medium">4+ years</strong> of experience
                    delivering Flutter applications. I build end-to-end solutions using Clean Architecture and BLoC,
                    with API integrations and native capabilities. Focused on performance, reliability, and
                    maintainability.
                </motion.p>
                <motion.div
                    initial={reduceMotion ? false : {opacity: 0, y: 20}}
